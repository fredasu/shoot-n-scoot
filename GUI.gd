...
var fen = "pppppppp/8/8/8/8/8/8/3Q4 w KQkq - 0 1"	#lowercase = black
...
#func _on_slot_clicked(slot)->void:
	...
	#mob.position = grid_array[slot.slot_ID].global_position + icon_offset
	#load("res://art_assets/enemyFlyingAlt_1.png")
	#
	#clear_board_filter()
	#piece_selected = null
	#
